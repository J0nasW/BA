...
% ***
	...
	\label{subsec:rl_qlearning}
		...
		Unmittelbar nach einer getätigten Aktion $a$ erhält der Agent neben dem State $x$ (ausgwählte Messgrößen wie bspw. der Winkel des inversen Pendels $\varphi$) den Reward $R_x(\pi(x))$. Aus diesen Informationen lässt sich der Wert des erhaltenen States $x$ berechnen:
		\begin{align}
