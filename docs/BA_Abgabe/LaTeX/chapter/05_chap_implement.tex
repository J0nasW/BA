...
% ***
	...
	\subsection{Suchalgorithmus Random-Search}
		...
		\end{algorithm}\\
		Die elementare Funktion \texttt{run\_episode} wird in Abschnitt \ref{sec:imp_sim} genauer erläutert. Sie enthält unter anderem auch die Funktion \texttt{compute}, welche in Abschnitt \ref{sec:lif_imp} bereits detailliert thematisiert wurde.
